...
public class FrameWindow extends JPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        systemPanel.setLayout(new FlowLayout(FlowLayout.RIGHT, 5, 5));
        systemPanel.setBackground(new Color(-1644826));
        systemPanel.setForeground(new Color(-1710619));
        rootPanel.add(systemPanel, BorderLayout.NORTH);
